function onReady(e) {
    window.removeEventListener("DOMContentLoaded",onReady,!1)
    window.removeEventListener("load",onReady,!1)
...
dateFormat.masks = {
    ...
    }(), this.Distilled = this.Distilled || {}, Distilled.DEBUG = !0, "loading"==document.readyState?(window.addEventListener("DOMContentLoaded",onReady,!1),window.addEventListener("load",onReady,!1)):onReady();
