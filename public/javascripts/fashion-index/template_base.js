    ...
    BloomiesLookbook = function(a, b) {
        ...
        return {
            ...
            setEventHandlers: function() {
                ...
                }), c.lookbook.on("touchstart", function(a) { /* b=!0;d={x:a.originalEvent.changedTouches[0].pageX,y:a.originalEvent.changedTouches[0].pageY}*/ }), c.lookbook.on("touchend", function(c) { /* var e=80;b=!1,"horizontal"===a.state.transitionDirection?Math.abs(c.originalEvent.changedTouches[0].pageX-d.x)>e&&(c.originalEvent.changedTouches[0].pageX>d.x?a.goToPrev():a.goToNext()):Math.abs(c.originalEvent.changedTouches[0].pageY-d.y)>e&&(c.originalEvent.changedTouches[0].pageY>d.y?a.goToPrev():a.goToNext()) */ }), c.lookbook.on("touchmove mousemove", function() {}), c.lookbook.find(".back-to-top-button").click(function() {
                    $("body, html").animate({
                        scrollTop: 0
                    }, 500)
