...
// ===== END SOCIAL =====
  ...
  $('#mobile-header .menu a').on('click tap', function () {
    $('#mobile-header .menu').slideToggle('open');
  ...
  // vertical space adjustment for denim-dictionary mobile elements
  ...
  // Blog denim-dictionary more/less action
  $('#denim-dictionary .more, #denim-dictionary .less').on('click tap', function(e) {
    e.preventDefault();
