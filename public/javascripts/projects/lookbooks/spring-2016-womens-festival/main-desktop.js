...
window.TEMPLATE.vertical = (function(window, document, $) {
    ...
    var APP = {
        ...
        social: {
            ...
            twitterTitle: 'Grab the squad and set off for the festival circuit in key pieces that are as epic as the lineup itself @bloomingdales http://bit.ly/1MhLMk1',
            pinterestTitle: 'Women\'s Festival | Bloomingdale\'s',
