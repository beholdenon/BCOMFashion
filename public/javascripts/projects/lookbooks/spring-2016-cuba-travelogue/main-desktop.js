...
window.TEMPLATE.vertical = (function(window, document, $) {
    ...
    var APP = {
        cm: 'spring16_cuba', //coremetrics project prefix
        ...
        social: {
            facebookTitle: 'CUBA RISING | A Bloomingdale’s Travelogue',
            facebookDescription: 'When we shot our men’s spring collection in Cuba, we stuck around for a while. Check out all the highlights and insider tips from our time in Old Havana.',
            facebookImageFileName: 'S16_MENS_CUBA_FACEBOOK.jpg',
            twitterTitle: 'Cuba Rising: Check out highlights and insider tips from our time in Old Havana @ http://bit.ly/1XJa6BW',
            pinterestTitle: 'CUBA RISING | A Bloomingdale’s Travelogue',
            pinterestImageFileName: 'S16_MENS_CUBA_PINTEREST.jpg',
            facebookURL: null,
            twitterURL: null,
            pinterestURL: null
        },
...
/***********************************************/     
    ...
    APP.desktopHeaderVisible = function () {
        if( $('.desktop_header').is(':in-viewport') ) {
            $('.desktop_header').addClass('active');
            $('#desktop_nav_cuba-rising').addClass('active');
        } else { 
            $('.desktop_header').removeClass('active');  
            $('#desktop_nav_cuba-rising').removeClass('active');
        }
    };
