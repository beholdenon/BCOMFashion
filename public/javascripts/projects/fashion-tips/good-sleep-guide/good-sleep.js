...
require( [ 'jquery', window.BLOOMIES.coremetrics ], function ( $, Coremetrics ) {	
	...
	var Mobile = (function() {
		...
		module.loadCSS = function( callback ) {
			...
			$( '#bl_main_wrapper, #bl_main_container' ).css( { 'width': '100vw', 'min-width': '0' } );
			//}*/

			$('html').attr('style', $('#fall15_utilityfinder_loader').attr('style')).css('height', '100%');
			// loadCSS( stylesURL + 'mobile.css', 0, 0, function () {
...
// function loadCSS(b,c,d,e){"use strict";var f=window.document.createElement("link");var g=c||window.document.getElementsByTagName("script")[0];var h=window.document.styleSheets;f.rel="stylesheet";f.href=b;f.media="only x";f.onload=e||function(){};g.parentNode.insertBefore(f,g);function toggleMedia(){var a;for(var i=0;i<h.length;i++){if(h[i].href&&h[i].href.indexOf(b)>-1){a=true}}if(a){f.media=d||"all"}else{setTimeout(toggleMedia)}}toggleMedia();return f};
