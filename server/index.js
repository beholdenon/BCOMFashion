...
var routes = [
    ...
    { method: 'GET',  path: '/about-us/{path*}',                                    config: require('./lib/handlers/views').nonResponsive },
    ...
    { method: 'GET',  path: '/service/ibmdigitalanalytics_options/',                config: require('./lib/handlers/views').nonResponsive },
