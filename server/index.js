...
var routes = [
    ...
    { method: 'GET',  path: '/international/',                                      config: require('./lib/handlers/views').responsiveCustomHF },
    { method: 'GET',  path: '/international/components/{path*}',                    config: require('./lib/handlers/assets').ngViews },
