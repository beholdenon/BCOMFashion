...
var routes = [
    ...
    { method: 'GET',  path: '/landing-page/hawaii-ala-moana/{path*}',               config: require('./lib/handlers/views').responsive },
    { method: 'GET',  path: '/landing-page/hawaii-ala-moana/',                      config: require('./lib/handlers/views').responsive },
