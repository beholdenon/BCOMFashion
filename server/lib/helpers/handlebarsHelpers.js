...
Handlebars.registerHelper('ifUnavailableValues', function(facetSelectionModalModel, options) {
    if (_.find(facetSelectionModalModel.facet.value, {
            productcount: 0
        })) {
        return options.fn(this);
    }
...
Handlebars.registerHelper('absoluteUrl', function(urlPath) {
    var absoluteUrl, $url = $.url(urlPath),
        host = $url.attr('host');
...
Handlebars.registerHelper('hasBagItems', function(options) {
    ...
    _.each(this.items, function(item) {
        var renderItem = (itemType == 'all') || ((itemType == 'merged') && !item.mergeRequiredFlag) || ((itemType == 'unmerged') && item.mergeRequiredFlag);
