 ...
 */
module.exports = function(grunt, brand, commonSrc, brandSrc) {
  'use strict';
  ...
  var folders = [brandSrc + "/scripts/", commonSrc +  "/scripts/"];
  ...
  _.forEach(folders, function(folder) {
    ...
    if (isCommon) {
      grunt.file.recurse(folder, function(abspath) {
        ...
        var brandPath = abspath.replace(commonSrc, brandSrc).replace(filename, filename.replace('_', ''));
